...
**OpenSSH key Note:** If you are using Putty, you want to open Puttygen (if this is not open already), and load the .ppk file, which holds your key. Then you want to copy the text in the first textbox for pasting into the instance at step 3. 
